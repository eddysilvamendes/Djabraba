...
$expected = ['nome', 'numero_quartos', 'telefone', 'nacionalidade','email','conhecimento','motivo','Atendimento_no_momento_da_Reserva','Atendimento_ao_balcão','Funcionarios','Check-In','Check-Out','Segurança',
'Comforto_e_Limpeza_dos_Quartos','Pequeno-Almoço','Envolvente_externo_ao_empreendimento','Internet','Acessibilidade_ao_empreendimento','Acessibilidade_a_Ilha','mensagem'];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'marcogiandinoto@gmail.com'  =>
            ['#subject#' => 'Avaliação DJABRABAS ECO-LODGE']
   ];
    ...
    try {
        ...
        $message = Swift_Message::newInstance()
            ...
            $image_ilha = $message->embed(Swift_Image::fromPath('assets/img/brava.png'));
            $image_logo = $message->embed(Swift_Image::fromPath('assets/img/logo1.png'));
...
<title>DJABRABAS ECO-LODGE </title>
</head>
...
center">Avaliação DJABRABAS ECO-LODGE</h1>
</td>
</tr>
<tr>
