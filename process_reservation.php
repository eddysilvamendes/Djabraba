...
$expected = ['nome', 'numero_quartos', 'telefone', 'nacionalidade','email','numero_doc','endereco','Checkin','Checkout','Quartos','numero_adultos','mensagem'];
$required = ['nome', 'numero_quartos', 'telefone', 'nacionalidade','email','numero_doc','endereco','Checkin','Checkout',];
...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'marcogiandinoto@gmail.com'  =>
            ['#subject#' => 'Pedido de Reserva DJABRABAS ECO-LODGE']

        $email =>
            ['#subject#' => 'DJABRABAS ECO-LODGE Reservation Request',
...
center">Pedido de Reserva DJABRABAS ECO-LODGE</h1>
</td>
</tr>
<tr>
